  ...
  const renderDocContent = () => {
    switch (selectedDoc) {
      case 'doc1':
        return (
          <div className=''>
            <Title level={2} className="text-2xl">Use Cases (Part 1)</Title>
            <h2 id="fire-detection" className="text-xl">1. Fire Detection</h2>
            ...
            <h2 id="auction" className="text-xl">2. Auction</h2>
      ...
      case 'doc2':
        return (
          <div>
            <Title level={2} className="text-2xl">Use Cases (Part 2) & Technical Stack (Part 1)</Title>
            <h2 id="fertilizer-prediction" className="text-xl">3. Fertilizer Prediction</h2>
            <p><strong>Actor:</strong> Farmer</p>
            ...
            <img src={Bayes} alt="Bayes" className='w-2/3 h-ato'/>
            <h2 id="additional-use-cases" className="text-xl">4. Additional Use Cases</h2>
            ...
            <h2 id="tech-stack" className="text-xl">1. Technical Stack Overview</h2>
